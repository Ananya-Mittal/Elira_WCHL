      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl border-0">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-2xl font-playfair text-gray-900">Join ELIRA Today</CardTitle>
            <CardDescription className="text-gray-600">Empower your business journey with us</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="isSeller" className="text-sm text-gray-700">
                  I want to sell products on ELIRA
                </Label>
              </div>
